var menu_template = `
	<ul>
		...
		<a data-target="samsung/change_color.pick_color">
		
		<input type="color" id="samsung_color"></a>
		<li>
			<a class="trn" href="#">Samsung Rect</a>
			<ul>
				<li><a class="trn dots" data-target="samsung/change_color.printMgs1" href="#">Info</a></li>
				<li class="more">
					<a class="trn" href="#">Change color</a>
					<ul>
						<li><a data-target="samsung/change_color.change_color" href="#">Blue #42a5f5</a>
						<li><div class="mid-line"></div></li>
						<li><a data-target="samsung/change_color.pick_color" href="#">Select custom color</a>
					</ul>
				</li>
				<li><div class="mid-line"></div></li>
				<li><a class="trn dots" data-target="help/about.about" href="#">About</a></li>
